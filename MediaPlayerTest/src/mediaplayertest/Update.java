...
public class Update extends javax.swing.JFrame {
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        insert(title.getText(), year.getSelectedItem().toString(), genre1.getSelectedItem().toString(),
                genre2.getSelectedItem().toString(), genre3.getSelectedItem().toString(), director.getText(),
                actor.getText(), country.getSelectedItem().toString() , synopsis.getText(), newImageLoc );
